...
router.get("/filter", (req, res) => {
  ...
  let filterLetter = req.query.letter; //filter by starting letter
...
router.get("/:id", (req, res) => {
  ...
  let friendId = parseInt(req.params.id,10); // 'id' here will be a value matching anything after the / in the request path
